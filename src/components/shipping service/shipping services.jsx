    ...
    <>
      <div className="shipping-service-wrap">
        <div className="shipping-service">
          <div className="head-of-service">
            <h1>Shipping Service</h1>
          </div>

          <p className="shiping-p">
            Lorem sequi perspiciatis laboriosam? Maiores, incidunt fugit.
            Officiis, est quisquam? Sunt, ipsa qui.
          </p>
          <div className="shipping-box-flexer">
            <div className="shipping-service-box-wrap">
              <div className="shipping-service-box">
                <svg
                  id="svg-of-shipping-service"
